...
IMG_REL_PATH = r'pic\bgPic.png'             # base pic directory
FONT_REL_PATHS = ['fonts\Poppins-Bold.ttf', 'fonts\SpaceMono-Regular.ttf']  #fonts
FONT_PATHS = [os.path.join(os.getcwd(), path) for path in FONT_REL_PATHS]
...
if __name__=='__main__':
    ...
    while(remaining>0):
        ...
        img_clone.save(OUTPUT_ABS_PATH)
